...
Param (
	...
	[string[]]
	$CommandPath = @("$global:testroot\..\AppLockerFoundry\functions", "$global:testroot\..\AppLockerFoundry\internal\functions"),
	
	[string]
	$ModuleName = "AppLockerFoundry",
...
$CommandPath = @(
    "$global:testroot\..\AppLockerFoundry\functions"
    "$global:testroot\..\AppLockerFoundry\internal\functions"
)
