...
Remove-Module AppLockerFoundry -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\AppLockerFoundry\AppLockerFoundry.psd1"
Import-Module "$PSScriptRoot\..\AppLockerFoundry\AppLockerFoundry.psm1" -Force
